...
export const NewOrganization = (props) => {
  ...
  const [organizationContainers, setOrganizationContainers] = useState([
  ...
  const handleSaveOrganization = () => {
    ...
    if (!props.edit) {
      ...
      if (!mappedOrganizationData.password)
        delete mappedOrganizationData.password;
      if (!mappedOrganizationData.passphrase)
        ...
        >
          ...
          >
            <Typography variant="h4" mb={{ xs: "5vh", md: "3vh" }}>
              {props.edit ? "Edit" : "Create"} an organization
            </Typography>

            {/* // ORGANIZATION */}
            <Typography variant="h5" mt="4vh">
            ...
            <Box sx={{ width: { xs: "98%", sm: "49%" } }}>
              <TextField
                ...
                name="stNumber"
                onChange={handleOrganizationAddressChange}
                value={organization?.address?.stNumber}
                label="No."
                type="number"
                sx={() => ({
                  ...BV_THEME.input.mobile.fullSize.desktop.halfSize,
            ...
            />
            <TextField
              id="organizationReferences"
              name="references"
              onChange={handleOrganizationAddressChange}
              value={organization?.address?.references}
              multiline
              label="References"
              sx={() => ({
                ...BV_THEME.input.mobile.fullSize.desktop.halfSize,
            ...
            <Box sx={{ width: { xs: "98%", sm: "49%" } }}>
              <TextField
                id="organizatioLnatitude"
                name="latitude"
                onChange={handleOrganizationAddressCoordsChange}
                value={organization?.address?.coords?.latitude}
                label="Latitude"
                type="number"
                sx={() => ({
                  ...BV_THEME.input.mobile.fullSize.desktop.halfSize,
              ...
              <TextField
                ...
                name="longitude"
                onChange={handleOrganizationAddressCoordsChange}
                value={organization?.address?.coords?.longitude}
                label="Longitude"
                type="number"
                sx={() => ({
                  ...BV_THEME.input.mobile.fullSize.desktop.halfSize,
                ...
                >
                  <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                    ...
                    >
                      ...
                      {organizationContainers.length > 1 ? (
                        <Delete
                          color="error"
                          onClick={(e) => deleteContainer(index, e)}
                          sx={{ marginTop: ".5vh" }}
                        />
                      ) : null}
                    </Box>
                  ...
                  >
                    <TextField
                      name="name"
                      onChange={(event) =>
                        handleOrganizationContainersChange(event, index)
                      }
                    ...
                    <TextField
                      ...
                      label="Capacity"
                      InputProps={{
                        endAdornment: <Typography>/trays</Typography>,
                      }}
                      sx={() => ({
                        ...BV_THEME.input.mobile.fullSize.desktop.halfSize,
                      })}
                    ...
                    <Tooltip
                      title={
                        container.check
                          ...
                          : "Click to use organization address"
                      }
                      arrow
                    >
                      <Checkbox
                        icon={<DomainAddIcon color="primary" />}
                        checkedIcon={<DomainDisabledIcon color="error" />}
                    ...
                    <TextField
                      name="street"
                      onChange={(event) =>
                        handleOrganizationContainersAddressChange(event, index)
                      }
                      value={
                        container.check
                          ? organization?.address?.street
                    ...
                    >
                      <TextField
                        name="stNumber"
                        onChange={(event) =>
                          handleOrganizationContainersAddressChange(
                            event,
                            index
                          )
                        }
                    ...
                    <TextField
                      ...
                      value={
                        container.check
                          ? organization?.address?.references
                          : container?.address?.references
                      }
                      multiline
                      label="References"
                    ...
                    >
                      <TextField
                        name="latitude"
                        onChange={(event) =>
                          handleOrganizationContainersAddressCoordsChange(
                            event,
                            index
                          )
                        }
                        value={
                          container.check
                            ? organization?.address?.coords?.latitude
                            : container?.address?.coords?.latitude
                        }
                        label="Latitude"
                        type="number"
                      ...
                      <TextField
                        ...
                        value={
                          container.check
                            ? organization?.address?.coords?.longitude
                            : container?.address?.coords?.longitude
                        }
                        label="Longitude"
                        type="number"
            ...
            {/* // ADMIN */}
            <Typography variant="h5" mt="4vh" align="left">
              {props.edit ? "Edit" : "New"} admin account Information
            </Typography>
            <Divider
              variant="middle"
              sx={{
            ...
            <Box sx={{ width: { xs: "98%", sm: "49%" } }}>
              ...
              <TextField
                ...
                error={Boolean(errorMessages.lname)}
                helperText={errorMessages.lname || ""}
              />
            </Box>
            <Box
              sx={{
            ...
            >
              <TextField
                id="phoneExt"
                name="phoneExt"
                onChange={handlePhoneExt}
                value={phoneExt}
                label="Ext"
                sx={() => ({
                  ...BV_THEME.input.mobile.fullSize.desktop.quarterSize,
                })}
                error={Boolean(errorMessages.phoneExt)}
                helperText={errorMessages.phoneExt || ""}
              />
              <TextField
                id="phone"
                name="phone"
            ...
            <Box sx={{ width: { xs: "98%", sm: "49%" } }}>
              ...
              <TextField
                ...
                error={Boolean(errorMessages.passphrase)}
                helperText={errorMessages.passphrase || ""}
              />
            </Box>
            {/* // SAVE */}
            <Button
