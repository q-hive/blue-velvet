        ...
        setOrganizationContainers((prevContainers) => {
            ...
            updatedContainers[index] = {
                ...
                address: {
                    ...
                    coords: {
                        ...updatedContainers[index].address.coords,
                        [name]: value,
                    },
                },
            };
        ...
        if (props.edit) {
            ...
            getOrganization(id)
                .then((res) => {
                    ...
                    setPhoneExt(
                        OrganizationInEdition.admin.phone.substring(0, 3)
                    );
                ...
                >
                    ...
                    >
                                ...
                                >
                                    ...
                                    >
                                        <TextField
                                            name="name"
                                            onChange={(event) =>
                                                handleOrganizationContainersChange(
                                                    event,
                                                    index
                                                )
                                            }
                                            ...
                                            label="Name"
                                            sx={() => ({
                                                ...BV_THEME.input.mobile
                                                    .fullSize.desktop.fullSize,
                                            })}
                                        />
                                        <TextField
                                            name="capacity"
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                checkedIcon={
                                                    <DomainDisabledIcon color="error" />
                                                }
                                                onChange={() =>
                        ...
                        <Typography variant="h5" mt="4vh" align="left">
                            {props.edit ? "Edit" : "New"} admin account
                            Information
                        </Typography>
                        <Divider
                            variant="middle"
